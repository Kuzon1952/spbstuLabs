...
#include "Shape.h"      // Base class first
#include "MyVector.h"   // Then derived classes
#include "Rect.h"
#include "Circle.h"
#include "MyString.h"
...
//-> В строке Vector c = a; создаётся новый объект c, поэтому вызывается конструктор копирования, а не оператор присвоения.
	...
	// Вызывается ли эта операция в в этом фрагменте? Почему?
	 // Answer: NO, assignment operator is NOT called here
    // This calls COPY CONSTRUCTOR, not assignment operator
	MyString ss = s;
