...
В папке tests реализован класс HumanPlayer, который позволяет:
   ...
   - Играть против базовых игроков (легкого и сложного), чтобы понять их стратегии
...
//what i must have to show in the otchot:

//time for each move and processor 
//algorithms i have to show with flow-chart
//also i have to show mathematically 
//tests : with baseline 1000 times as X and as O
//aslo tests with my_player vs my_player
//screen sort of ans 
