...
void trim(char* str) {
    ...
    if (*str == 0) return; // Empty string check
 ...
 */
    ...
    {   
        ...
        freeCatalog(&catalog);//free memory
 ...
 */
    {
        ...
        printf("Would you like to print the catalog? (y/n): ");
        scanf(" %c", &userInput);
        ...
        if (userInput == 'y' || userInput == 'Y') {
            ...
            printf("\nCatalog printing skipped.\n");
        }

        
        freeCatalog(&catalog);//free the catalog resources
    ...
    while(!exitProgram){
        ...
        switch (userInput) {
            ...
            case '4':// Search for a book
                if (!isCatalogFreed) {
                    char criterion[20], value[256];
                    printf("Enter search criterion (title, author, genre): ");
                    scanf(" %s", criterion);
                    printf("Enter value to search: ");
                    scanf(" %s", value);
                    searchBooks(&catalog, criterion, value);
                } else {
 ...
 */
{
    ...
    if (!isCatalogFreed) {
        ...
        fgets(title, sizeof(title), stdin); // Use fgets instead of scanf
        trim(title); // Trim any leading/trailing whitespaces or newline characters
    ...
    while(!exitProgram){
        ...
        switch (userInput) {
            ...
            case '7'://exit
                ...
                break;
            default:
                printf("Invalid option. Please choose a valid option (1-7).\n");
                break;
        }
    }
    ...
    while(!exitProgram){
        ...
        scanf(" %c", &userInput);
            ...
            case '9'://exit
                ...
                break;
            default:
                printf("Invalid option. Please choose a valid option (1-9).\n");
                break;
        }
    }
...
//additional task
{
    //additional task
    {
        ...
        while(!exitProgram){
            printf("\nMenu:\n");
            printf("0. Add a new book\n");
            printf("1. Display catalog\n");
            printf("2. Sort catalog\n");
            printf("3. Search for a book\n");
            printf("4. Delete a book\n");
            printf("5. Modify a book\n");
            printf("6. Save catalog to a file\n");
            printf("7. Load catalog from a file\n");
            printf("8. Display books by author and/or genre\n");
            printf("9. Exit\n");
            printf("Choose an option (1-9): ");
            ...
            switch (userInput) {
                ...
                case '8'://display books by author and/or genre
